...
import proyectodealimentacions.accesodatos.CategoriaDAL;
import proyectoalimentacion.appweb.utils.Utilidad;
import proyectodealimentacions.entidadesdenegocio.Categoria;
...
public class CategoriaServlet extends HttpServlet {
    ...
    private Categoria obtenerCategoria(HttpServletRequest request) {
        ...
        categoria.setDesayuno(Utilidad.getParameter(request, "nombre", ""));
